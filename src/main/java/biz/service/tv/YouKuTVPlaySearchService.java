...
@Lazy
@Scope("singleton")
public class YouKuTVPlaySearchService implements TVPlaySearchServiceInterface {
    @Override
    public void analyseBigData(Map<String, Object> map,
        ...
        String json = "";
        try {
             json = HttpRequestUtil.requestHttp("https://so.youku.com/search_video/bigword?keyword="+ URLEncoder.encode("电视剧","utf-8") +"&pz=12&pg="+pageIndex,"utf-8","GET");
