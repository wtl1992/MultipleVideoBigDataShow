        ...
        success: function (data) {
            ...
            if (data.length > 0) {
                for (var i = 0; i < data[0]["pageCount"]; i++) {
                    if (i == pageIndex - 1) {
                        sPageHtml += "<li class='current'><a href=\"m/getThunderResult?keyword=" + keyword + "&typeid=" + typeid2 + "&pageIndex=" + (i + 1) + "\">" + (i + 1) + "</a></li>";
                    }
                    else {
                        sPageHtml += "<li><a href=\"m/getThunderResult?keyword=" + keyword + "&typeid=" + typeid2 + "&pageIndex=" + (i + 1) + "\">" + (i + 1) + "</a></li>";
                    }
            ...
            for (var i = 0; i < thunderSearchs.length; i++) {
                sthunderSearchHtml += "<li>\n" +
                    "                <p class=\"title\">\n" +
                    "                    <a href=\""+("m/getThunderDownloadResult?url="+window.encodeURIComponent(thunderSearchs[i]["downloadPageUrl"]))+"\">"+thunderSearchs[i]["title"]+"</a>\n" +
                    "                </p>\n" +
