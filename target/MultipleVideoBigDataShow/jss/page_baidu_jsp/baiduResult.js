        ...
        success: function (data) {
            ...
            if (data.length > 0){
                for (var i=0;i<data[0]["pageCount"];i++){
                    if (i == pageIndex - 1){
                        sPageHtml += "<li class='current'><a href=\"baiduyunwangpanSearchResult?keyword="+keyword+"&pageIndex="+(i+1)+"\">"+(i+1)+"</a></li>";
                    }
                    else{
                        sPageHtml += "<li><a href=\"baiduyunwangpanSearchResult?keyword="+keyword+"&pageIndex="+(i+1)+"\">"+(i+1)+"</a></li>";
                    }
