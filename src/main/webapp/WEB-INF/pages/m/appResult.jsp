...
<div style="position: fixed;left: 0;top: 0;width: 100%;max-height:409px;background-color: rgba(0,0,0,.6);
z-index: 99999;">
    <div class="oneLine">
        <a title="祥龙检索，搜app"><img src="../images/index_jsp/homelogo.png"/></a>
    </div>
    <p style="margin: 0px auto;text-align: center;
position: relative;left: 0px;top: -3px;color: #FFFFFF;">可以搜索app名称等</p>
...
<script type="text/javascript" src="../jss/m/page_app_jsp/appResult.js"></script>
</body>
</html>
