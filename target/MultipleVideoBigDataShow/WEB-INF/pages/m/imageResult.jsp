...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/m/page_image_jsp/imageResult.css"/>
    <!--
...
z-index: 99999;">
    <div class="oneLine">
        <a title="祥龙检索，搜图片"><img src="../images/index_jsp/homelogo.png"/></a>
    </div>
    <p style="margin: 0px auto;text-align: center;
position: relative;left: 0px;top: -6px;color: #FFFFFF;">可以搜索图片类别、名称等</p>
...
<script type="text/javascript" src="../jss/m/page_image_jsp/imageResult.js"></script>
</body>
</html>
