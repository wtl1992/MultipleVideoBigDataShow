...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/m/page_baidu_jsp/baiduResult.css"/>
    <!--
...
position: relative;left: 0px;top: -6px;color: #FFFFFF;">可以搜索百度网盘资源名字等，<br/><a href="https://pan.baidu.com/" target="_blank" style="color: red;text-decoration: underline;">请先下载安装百度网盘软件</a></p>
...
<script type="text/javascript" src="../jss/m/page_baidu_jsp/baiduResult.js"></script>
</body>
</html>
