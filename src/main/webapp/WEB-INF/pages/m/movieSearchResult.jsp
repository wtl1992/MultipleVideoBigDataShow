...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/m/page_movie_jsp/movieSearchResult.css"/>
    <!--
...
z-index: 99999;">
    <div class="oneLine">
        <a title="祥龙检索，搜电影"><img src="../images/index_jsp/homelogo.png"/></a>
    </div>
    <p style="margin: 0px auto;text-align: center;
position: relative;left: 0px;top: -6px;color: #FFFFFF;">可以搜索电影名称或者演员名字等</p>
...
<script type="text/javascript" src="../jss/m/page_movie_jsp/movieSearchResult.js"></script>
</body>
</html>
