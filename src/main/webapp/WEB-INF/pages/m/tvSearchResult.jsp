...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/m/page_tvPage_jsp/tvSearchResult.css"/>
    <!--
...
<script type="text/javascript" src="../jss/m/page_tvPage_jsp/tvSearchResult.js"></script>
</body>
</html>
