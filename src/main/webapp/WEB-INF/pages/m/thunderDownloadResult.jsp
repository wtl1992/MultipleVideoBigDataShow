...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/m/page_thunder_jsp/thunderDownloadResult.css"/>
    <!--
        <link rel="stylesheet" type="text/css" href="styles.css">
        -->
    <script type="text/javascript" src="../jss/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="../jss/page_thunder_jsp/base64.js"></script>
    <script type="text/javascript" src="../jss/page_thunder_jsp/urlconvert.js"></script>
</head>
...
z-index: 99999;">
    <div class="oneLine">
        <a title="祥龙检索，搜迅雷资源"><img src="../images/index_jsp/homelogo.png"/></a>
    </div>
...
<div class="list-view">
    <ul class="thunderDownloadUl">
    </ul>
</div>
<i id="url" style="display: none;">${url}</i>
...
<script type="text/javascript" src="../jss/m/page_thunder_jsp/thunderDownloadResult.js"></script>
</body>
</html>
