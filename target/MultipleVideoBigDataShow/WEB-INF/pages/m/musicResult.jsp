...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/m/page_music_jsp/musicResult.css"/>
    <!--
...
position: relative;left: 0px;top: -6px;color: #FFFFFF;">可以搜索音乐类别、名称等</p>
...
<script type="text/javascript" src="../jss/m/page_music_jsp/musicResult.js"></script>
</body>
</html>
