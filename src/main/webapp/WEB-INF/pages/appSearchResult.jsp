...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/page_app_jsp/appSearchResult.css"/>
    <!--
...
position: relative;left: 0px;top: 64px;color: #FFFFFF;">可以搜索app名字或者app类别等</p>
...
<script type="text/javascript" src="jss/page_app_jsp/appSearchResult.js"></script>
</body>
</html>
